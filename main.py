...
def respond(voice_data):
  ...
  # 3: Origin
    ...
    if there_exists(["who are you","your inventor","invented you","created you","who is your developer"]):
        greetings = ["I am Virtual Voice Assistant","I am developed by vijaya kumar,sarathy, mukunthan s  as a voice assistance"] # You can Add your name
        greet = greetings[random.randint(0,len(greetings)-1)]
        speak(greet)
    ...
    #office room
    if there_exists(["where is office room","where is a office room","office room"]):
       greetings = ["located in admin block first floor then take  center step and take left then your destination will be reached"]
       greet = greetings[random.randint(0,len(greetings)-1)]
       speak(greet)
    ...
    #library
    if there_exists(["where is library","where is a library","library"]):
       greetings = ["located in admin block first floor then take  center step and take right then your destination will be reached"]
       greet = greetings[random.randint(0,len(greetings)-1)]
       speak(greet)
    ...
    if there_exists(["where is computer science department","where is a computer science department","computer science department"]):
       greetings = ["on circuit block third floor"]
       greet = greetings[random.randint(0,len(greetings)-1)]
       speak(greet)

    if there_exists(["where is 3rd year cse b class","where is a 3rd year cse b class","3rd year cse b class"]):
       greetings = ["on circuit block third floor"]
       greet = greetings[random.randint(0,len(greetings)-1)]
       speak(greet)

    if there_exists(["where is 3rd year cse b section","where is a 3rd year cse b section","3rd year cse b section"]):
       greetings = [" located on circuit block third floor"]
       greet = greetings[random.randint(0,len(greetings)-1)]
       speak(greet)


    #ece departmentL:
    if there_exists(["where is ece department","where is a ece department","ece department"]):
       greetings = ["on circuit block forth floor"]
       greet = greetings[random.randint(0,len(greetings)-1)]
       speak(greet)
    ...
    if there_exists(["where is mechanical department","where is a mechanical department","mechanical department"]):
       greetings = ["on admin block second floor"]
       greet = greetings[random.randint(0,len(greetings)-1)]
       speak(greet)
    ...
    #civil department:
    if there_exists(["where is civil department","where is a civil department","civil department"]):
       greetings = ["on admin block third floor"]
       greet = greetings[random.randint(0,len(greetings)-1)]
       speak(greet)

    #boys rest room:
    if there_exists(["where is boys restroom","where is a boys restroom","boys restroom"]):
       greetings = ["on admin block each floor on the right croner"]
       greet = greetings[random.randint(0,len(greetings)-1)]
       speak(greet)
